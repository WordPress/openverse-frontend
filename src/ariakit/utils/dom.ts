/**
 * @see https://raw.githubusercontent.com/ariakit/ariakit/5d80a94b9413f0c2b826af55af9ee10e421d8c09/packages/ariakit-utils/src/dom.ts
 */
 ...
 */
export function contains(parent: Node | null, child: Node): boolean {
...
export function getPopupRole(
  ...
  fallback?: HTMLAttributes['aria-haspopup']
) {
