 ...
 */
const SCREENS =
  /** @type {Record<import('~/types/screens').RealBreakpoint, string>} */ (
    Object.fromEntries(
 ...
 */
const VIEWPORTS =
  /** @type {Record<import('~/types/screens').Breakpoint, import('~/types/screens').Viewport>} */ (
    Object.fromEntries(
      /** @type {[import('~/types/screens').Breakpoint, number][]} */ (
        Object.entries(SCREEN_SIZES)
      )
        .concat([['xs', 340]])
        .map(([key, val]) => [
