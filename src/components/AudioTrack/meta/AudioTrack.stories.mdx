...
`layout` prop. The layout can further be customised by the `size` and `aspect`
props.
...
**Sizes:** M (medium) and L (large)
**Aspects:** wide (only on size M)
