<template>
  <button
    type="button"
    class="flex flex-row items-center p-2 pe-3 rounded-sm text-sr font-semibold border border-dark-charcoal focus-visible:outline-none focus-visible:ring focus-visible:ring-pink hover:text-white hover:bg-dark-charcoal focus-visible:hover:border-white focus-visible:border-tx"
    :class="[
      selected
