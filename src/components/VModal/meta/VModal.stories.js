...
const DefaultStory = (args, { argTypes }) => ({
    ...
    <div>
      <VModal v-bind="args" :initial-focus-element="resolvedInitialFocusElement">
        ...
        <div class="p-4">
          ...
          <button type="button" ref="customInitialFocusElement">A focusable element that doesn't come first in the modal content</button>
  ...
  setup() {
    const customInitialFocusElement = ref()

    const resolvedInitialFocusElement = computed(() =>
      args.useCustomInitialFocus ? customInitialFocusElement.value : undefined
    )

    return { args, customInitialFocusElement, resolvedInitialFocusElement }
  },
})
