...
.snackbar {
  ...
  @apply fixed bottom-4 z-10 hidden rounded-sm bg-black text-white transition-[opacity,transform] duration-500 ltr:left-4 rtl:right-4 motion-reduce:transition-opacity md:block;
}
