import { actionsCreator } from '~/store/usage-data'
import { SEND_SEARCH_QUERY_EVENT } from '~/store/usage-data-analytics-types'
...
describe('Usage Data Store Store', () => {
  describe('actions', () => {
    ...
    beforeEach(() => {
      ...
      store = {
        actions: actionsCreator(usageDataServiceMock),
      }
    })
